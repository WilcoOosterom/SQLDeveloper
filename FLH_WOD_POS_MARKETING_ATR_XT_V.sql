---------------------------
--New VIEW
--FLH_WOD_POS_MARKETING_ATR_XT_V
---------------------------
CREATE OR REPLACE FORCE VIEW "RPT_VIEW_USER_RIS"."FLH_WOD_POS_MARKETING_ATR_XT_V" 
...
AND    SUBSTR(x.TEXT_LINE,INSTR(x.TEXT_LINE,';',1,1),INSTR(x.TEXT_LINE,';',1,31)) is not null
             -- get the character(s) from the first semicolon to the last semicolon
--AND  SUBSTR(x.TEXT_LINE,INSTR(x.TEXT_LINE,';', 1, 1),INSTR(x.TEXT_LINE,';',1,31)) !=   ';;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;';
