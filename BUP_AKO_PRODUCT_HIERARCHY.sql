---------------------------
--New TABLE
--BUP_AKO_PRODUCT_HIERARCHY
---------------------------
  CREATE TABLE "RPT_VIEW_USER_RIS"."BUP_AKO_PRODUCT_HIERARCHY" 
  ...
  COMMENT ON TABLE "RPT_VIEW_USER_RIS"."BUP_AKO_PRODUCT_HIERARCHY" IS 'Version 1.00.50';
