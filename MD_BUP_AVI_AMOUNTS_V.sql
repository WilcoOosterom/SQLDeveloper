---------------------------
--New VIEW
--MD_BUP_AVI_AMOUNTS_V
---------------------------
CREATE OR REPLACE FORCE VIEW "RPT_VIEW_USER_RIS"."MD_BUP_AVI_AMOUNTS_V" 
 ...
 *
 * Goal: Check on Amounts and receipts AVIFiles loaded
 *
 *----------------------------------------------------------------------------------------------------------------------*/
LINE_ITEM AS (
...
AND  LINE_ITEM.SALE_DATE = PAYMENT.SALE_DATE;
  COMMENT ON TABLE "RPT_VIEW_USER_RIS"."MD_BUP_AVI_AMOUNTS_V" IS 'Version 2019-41';
