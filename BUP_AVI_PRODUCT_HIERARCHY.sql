---------------------------
--New TABLE
--BUP_AVI_PRODUCT_HIERARCHY
---------------------------
  CREATE TABLE "RPT_VIEW_USER_RIS"."BUP_AVI_PRODUCT_HIERARCHY" 
  ...
  COMMENT ON TABLE "RPT_VIEW_USER_RIS"."BUP_AVI_PRODUCT_HIERARCHY" IS 'Version 1.00.50';
