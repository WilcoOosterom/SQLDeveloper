---------------------------
--New VIEW
--MD_BUP_CAP_FLIGHTINFO_V
---------------------------
CREATE OR REPLACE FORCE VIEW "RPT_VIEW_USER_RIS"."MD_BUP_CAP_FLIGHTINFO_V" 
 ...
 *
 * Goal: Check on flight information received from CAP
 *
 *----------------------------------------------------------------------------------------------------------------------*/
       BUP_CODE_SELLER
,      BUP_SUBCODE_SELLER
...
ORDER BY BUP_CODE_SELLER, BUP_SUBCODE_SELLER, FILE_NAME, SALE_DATE,ARRIVAL_DEPARTURE;
  COMMENT ON TABLE "RPT_VIEW_USER_RIS"."MD_BUP_CAP_FLIGHTINFO_V" IS 'Version 2019-41';
